    ...
    protected List<IDrawerItem> drawerItems() {
        return Arrays.<IDrawerItem>asList(
                new PrimaryDrawerItem()
                        ...
                        .withOnDrawerItemClickListener(goToActivityListener(ImageRecognizationActivity.class))
        );
    }
        ...
        return new Drawer.OnDrawerItemClickListener() {
            ...
            public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                ...
                if (!drawerItem.isSelected()) {
                    startActivity(new Intent(MainActivity.this, activityClass).putExtra(INTENT_EXTRA_DRAWER_POSITION, position));
                }
                return true;
            }
        };
