...
import tutorial.cs5551.com.productfinder.App;
import tutorial.cs5551.com.productfinder.ClarifaiUtil;
import tutorial.cs5551.com.productfinder.R;
...
/**
 * Created by prata on 9/27/2017.
 */

public class ImageRecognizationActivity extends BaseActivity {
    ...
    public void redirectToProductDetailsPage(View v) {
        Intent redirect = new Intent(ImageRecognizationActivity.this, ProductFinderActivity.class);
